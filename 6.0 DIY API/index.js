...
app.get('/filter', (req, res) => {
  ...
  const allFilterActivities = jokes.filter((joke) => joke.jokeType === filterType);
  res.json(allFilterActivities);
})
...
app.delete('/jokes/:id', (req, res) => {
  ...
  if(searchIndex > -1) {
    ...
    res
      .status(404)
      .json({ error: `Joke with ${id} not found. No jokes where deleted.` })
  }
  res.json('OK')
})
